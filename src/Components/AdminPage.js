    ...
    return (
        <div className="container mx-auto mt-8">
            <div className="flex flex-wrap">
                <div className={`lg:w-[30%] h-fit m-4 lg:m-10 lg:ml-2 px-4 pt-4 text-black rounded-lg shadow-2xl ${theme === "light" ? "bg-gray-200" : "bg-[#1A2130]  text-white"}`}>
            ...
            <div className={`lg:w-[95%] h-fit m-4 lg:m-10 lg:ml-2 px-4 pt-4 text-black rounded-lg shadow-2xl ${theme === "light" ? "bg-gray-200" : "bg-[#1A2130]  text-white"}`}>
                <h1 className="font-comfortaa font-medium text-[1.8rem] text-gray-500" style={{ textTransform: 'uppercase' }}>Users</h1>
                <UserTables />
            </div>
            <div className={`lg:w-[95%] h-fit m-4 lg:m-10 lg:ml-2 px-4 pt-4 text-black rounded-lg shadow-2xl ${theme === "light" ? "bg-gray-200" : "bg-[#1A2130]  text-white"}`}>
                <h1 className="font-comfortaa font-medium text-[1.8rem] text-gray-500" style={{ textTransform: 'uppercase' }}>Tickets</h1>
                <TicketTables />
            </div>
        </div>
    );
