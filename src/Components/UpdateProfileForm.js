...
//                     <input type="text" id="name" name="name" className="w-full p-2 mb-4 border rounded-lg focus:ring focus:ring-blue-200 text-gray-900" placeholder='Write your Name...' />
//                 </div>
//                 <div className='mb-4'>
//                     <label htmlFor="bio" className="text-[1.5rem] text-[#1A2130] font-comfortaa">Bio</label>
//                     <textarea id="bio" name="bio" className="w-full p-2 mb-4 border rounded-lg focus:ring focus:ring-blue-200 text-gray-900" placeholder='Describe yourself.....' />
//                 </div>
